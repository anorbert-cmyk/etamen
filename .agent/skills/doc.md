...
> **See:** `.agent/skills-reference/SKILLS_LIST_60.md`

A curated collection of **60 essential agent skills** from [SkillsMP.com](https://skillsmp.com) for daily programming, marketing, and design work. 7 categories: Frontend (10), Backend (8), Testing (8), Security/DevOps (8), Marketing/SEO (10), Productivity (8), Git/Automation (8). Includes installation guides, power combos, and source references (Anthropic Official, obra/superpowers, coreyhaines31/marketingskills, BehiSecc/awesome-claude-skills).