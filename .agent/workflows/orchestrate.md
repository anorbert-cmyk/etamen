...
> Before orchestrating, load relevant skills from `.agent/skills-reference/SKILLS_LIST_60.md`
> 60 curated skills from SkillsMP.com for programming, marketing, and design work.
